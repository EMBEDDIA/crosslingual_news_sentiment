...
from data_transform_overlapping import encode_labels, prepare_labeled_dataset, prepare_classification_head_dataset_averaging
...
def crossvalidation_sampling():
    ...
    output_dir = os.path.join(args.output_dir, "sampling_averaging")
    ...
    for i in range(10):
        ...
        classification_model = TwoLayerFCNet()
        ...
        classification_train_dataloader = prepare_classification_head_dataset_averaging(train_data, train_labels, model,
                                                                              tokenizer, device, args.max_len,
                                                                              args.batch_size)
        classification_eval_dataloader = prepare_classification_head_dataset_averaging(eval_data, eval_labels, model,
                                                                             tokenizer, device, args.max_len,
                                                                             args.batch_size)
        ...
        test_dataloader = prepare_classification_head_dataset_averaging(test_data, test_labels, model, tokenizer, device,
