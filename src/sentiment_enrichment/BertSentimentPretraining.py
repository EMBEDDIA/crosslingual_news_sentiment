from transformers.modeling_bert import BertLMPredictionHead, BertForPreTraining, BertModel
from torch import nn
from torch.nn import CrossEntropyLoss


class BertSentimentPretrainingHeads(nn.Module):
...
#class BertForSentimentPretraining(BertForPreTraining):
#    def __init__(self, config):
