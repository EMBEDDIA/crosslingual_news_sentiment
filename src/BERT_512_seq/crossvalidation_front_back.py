...
from data_transformation import encode_labels, cut_at_front_and_back
...
def crossvalidation_front_and_back():
    ...
    output_dir = os.path.join(args.output_dir, "cut_at_front_and_back_labels")
...
if __name__ == "__main__":
    crossvalidation_front_and_back()
